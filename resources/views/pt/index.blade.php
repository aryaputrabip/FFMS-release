...
@section('modal')
    ...
    <div class="modal fade" id="modal-performa-pt">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title text-dark">
                        <i class="fas fa-chart-line fa-sm mr-1"></i> Performa Personal Trainer (<span id="performaPTTitle"></span>)
                    </h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                ...
                <div class="modal-body" id="modal-pt-content">
                    <input type="hidden" id="tableFilterPT" readonly>
...
<script>
    ...
    function viewPerformaPT(id, name){
        $("#tableFilterPT").val(id);
        $("#performaPTTitle").html(name);
